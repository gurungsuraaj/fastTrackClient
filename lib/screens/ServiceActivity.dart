...
//              ]),
  ...
  List<ServiceModel> staticServiceList = [
    ...
    ServiceModel(
        title: "Battery",
        image: "images/batteryupdated.png",
        body:
    ...
    ServiceModel(
        title: "Suspension",
        image: "images/suspensionupdated.png",
        body:
    ...
    ServiceModel(
        title: "Tune Up",
        image: "images/tuneupupdated.png",
        body:
    ...
    ServiceModel(
        title: "Steering",
        image: "images/steeringupdated.png",
        body:
