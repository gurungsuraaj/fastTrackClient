...
<urn:staffID>101</urn:staffID>
  ...
  static Future<NetworkResponse> logIn(NTLMClient client) async {
    NetworkResponse rs = new NetworkResponse();
    var url = Api.POST_CHECKINVENTORY;
    var envelope =
        '''<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="urn:microsoft-dynamics-schemas/codeunit/CheckInventory">
<soapenv:Body>
<urn:Customerlogin>
<urn:mobileNo>101</urn:mobileNo>
<urn:passwordTxt>101</urn:passwordTxt>
</urn:Customerlogin>
</soapenv:Body>
</soapenv:Envelope>''';
    ...
    await client
        .post(url,
            headers: {
              ...
              "Accept-Chrset": "utf-8",
              "SOAPAction":
                  "urn:microsoft-dynamics-schemas/codeunit/CheckInventory"
            },
            body: envelope,
            encoding: Encoding.getByName("UTF-8"))
        .then((res) {
